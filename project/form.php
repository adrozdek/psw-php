...
<?php if (!empty($errors)) : ?>
    <div style="background-color: black; color: red; font-size: 25px; width: 100%; height: 90%;">
        ...
        <p>
            <a style="color: pink; font-size: 30px; font-weight: bold" href="index.html">Spróbuj jeszcze raz</a>
        </p>
    </div>
    <p>Dobre owocki:</p>
    <ul>
...
<?php else: ?>
    ...
    <p style="color: pink; font-size: 30px; font-weight: bold">
        <a style="color: pink; font-size: 30px; font-weight: bold" href="index.html">
